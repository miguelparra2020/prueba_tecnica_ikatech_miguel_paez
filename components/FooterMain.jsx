...
const FooterMain = () => {
  ...
  return (
    <div>
      <div className={styles.Content_footer_redes}>
          <div className={styles.div_fp_pagina_instagram}>
              @HUSHPUPPIESCO
          </div>
          <div className={styles.div_fp_divisor}>
          </div>
          <div className={styles.div_fp_redes_icons}>
          <Link href="https://www.instagram.com/miguelpaez.dev/" className={styles.button_link} target='_blank'>
              ...
              <div className={styles.div_buscador_envio}>
                <div className={styles.div_buscador}>
                  <div className={styles.div_input_icon_buscar}>
                          <input type="text" placeholder=' E-MAIL' value={email}  onChange={(e) => setEmail(e.target.value)} className={styles.input_buscar} />
                          
                    <div className={styles.div_buscador_icon}>
                      <button onClick={handleEmail} className={styles.button_link}>
